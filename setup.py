...
setup(
    ...
    packages=find_packages(include=['mattervial', 'mattervial.*', 'mattervial.packages.*', 'mattervial.packages.roost.*']),    include_package_data=True,  # Include non-Python files specified in MANIFEST.in
